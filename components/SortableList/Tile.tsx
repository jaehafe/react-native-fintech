...
const Tile = ({ id }: TileProps) => {
  ...
  if (id === 'spent') {
    return (
      <View style={styles.container} pointerEvents="none">
        ...
        <Text style={{ color: Colors.dark, fontWeight: 'bold', fontSize: 26, paddingTop: 10 }}>1024€</Text>
      </View>
    );
  }
  ...
  if (id === 'cashback') {
    return (
      <View style={[styles.container, { alignItems: 'center', justifyContent: 'center' }]} pointerEvents="none">
  ...
  if (id === 'recent') {
    return (
      <View style={styles.container} pointerEvents="none">
        <View>
          <Text style={{ color: Colors.gray, fontWeight: '500', fontSize: 16 }}>Recent transaction</Text>
  ...
  if (id === 'cards') {
    return (
      <View style={styles.container} pointerEvents="none">
        ...
        <Ionicons name="card" size={50} color={Colors.primaryMuted} style={{ marginTop: 20, alignSelf: 'center' }} />
      </View>
    );
  }
};
